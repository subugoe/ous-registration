<html>
    ...
    if (eregi("(opera) ([0-9]{1,2}.[0-9]{1,3}){0,1}", $version, $regs) || eregi("(opera/)([0-9]{1,2}.[0-9]{1,3}){0,1}", $version, $regs)) {
        ...
        if (eregi("(msie) ([0-9]{1,2}.[0-9]{1,3})", $version, $regs)) {
            $browser = "MS Internet Explorer";
            echo("Sie benutzen $browser!");

        } // FIREFOX
        else {
            if (eregi("(Firefox/)([0-9]{1,2}.[0-9]{1,3}.[0-9]{0,3}.[0-9]{0,3})", $version, $regs)) {
                ...
                if (eregi("(SeaMonkey/)([0-9]{1,2}.[0-9]{1,3}.[0-9]{0,3})", $version, $regs)) {
                    ...
                    if (eregi("(Safari)", $version, $regs)) {
                        $browser = "Safari";
                        echo("Sie benutzen $browser!");

                    } // MOZILLA
                    else {
                        if (eregi("(mozilla)/(.*)rv:([0-9]{1,2}.[0-9]{1,3}.[0-9]{0,3})", $version, $regs)) {
                            $browser = "Mozilla";
